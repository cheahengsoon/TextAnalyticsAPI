...
namespace TextAnalyticsAPI.Custom
{
    /// <summary>
    /// A view that shows a Pie chart with a given percentage and colors.
    /// </summary>
    public class PieChartsView : View
    {
        public static readonly BindableProperty ProgressProperty =
            BindableProperty.Create<PieChartsView, float>(
                p => p.Progress, 0);

        public static readonly BindableProperty RadiusProperty =
            BindableProperty.Create<PieChartsView, int>(
                p => p.Radius, 50);
        ...
        public static readonly BindableProperty ProgressBackgroundColorProperty =
            BindableProperty.Create<PieChartsView, Color>(
